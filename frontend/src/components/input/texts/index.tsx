...
function InputComponent({ label, inputType: type, inputPlaceholder: placeholder, inputId: id, inputName, divClassName, inputClassName, register, spanAlert, classNameSpanAlert, value }: InputProps) {
    return (
        <div className={`mb-4 ${divClassName}`}>
            ...
            <input
                ...
                id={id} name={inputName} placeholder={placeholder} type={type} {...register} value={value} />

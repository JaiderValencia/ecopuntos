...
function InputComponent({ label, inputType: type, inputPlaceholder: placeholder, inputId: id, inputName, divClassName, inputClassName }: InputProps) {
    return (
        <div className={`mb-4 ${divClassName}`}>
            ...
            <input
                ...
                id={id} name={inputName} placeholder={placeholder} type={type} />
        </div>
    )
}
